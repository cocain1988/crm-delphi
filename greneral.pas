...
ListBox1.Items.Add('Поставить товар в деревню');
ListBox1.Items.Add('--');
ListBox1.Items.Add('Свзяться с менеджером компании Лесоторговая');
ListBox1.Items.Add('--');
ListBox1.Items.Add('Связяться с поставщиком ООО Деталь');
ListBox1.Items.Add('--');
ListBox1.Items.Add('Перезвонить клиенту для сотрудничества');
ListBox1.Items.Add('--');
ListBox1.Items.Add('Проверить на складе наличие и колличество товара');
...
begin
  //Отображение окна формы добавления товаров
...
begin
//Отображение окна формы добавления кошелька пользователя
